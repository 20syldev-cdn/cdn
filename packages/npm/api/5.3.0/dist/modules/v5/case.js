...
const VALID_TARGETS = ['camel', 'pascal', 'snake', 'kebab', 'constant', 'title', 'sentence', 'upper', 'lower'];
 ...
 */
export default function caseConvert(text, to = 'camel') {
    if (!text)
        throw new Error('Please provide a text (?text={text})');
    if (text.length > MAX_STRING_LENGTH)
        throw new Error(`Text cannot exceed ${MAX_STRING_LENGTH} characters`);
