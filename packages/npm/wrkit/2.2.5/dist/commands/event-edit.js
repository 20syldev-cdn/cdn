...
export const command = {
    ...
    async execute(interaction, logger) {
        ...
        const debut = new Date(annee ?? e.scheduledStartAt.getFullYear(), (mois ?? e.scheduledStartAt.getMonth() + 1) - 1, jour ?? e.scheduledStartAt.getDate(), heure ?? e.scheduledStartAt.getHours(), minute ?? e.scheduledStartAt.getMinutes());
...
//# sourceMappingURL=event-edit.js.map